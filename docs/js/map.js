...
const finalMapConfig = {
    ...
    zoom: window.innerWidth > 768 ? 3.2 : 2.3,
    minZoom: 2,
    maxZoom: 18
};
...
function animateGlobeToFinalPosition() {
    ...
    const startCenter = [0, 90]; // North Pole
    const endCenter = [-98.5795, 39.8283]; // Final position in North America
    const startZoom = window.innerWidth > 768 ? 1.2 : 0.5;
    const endZoom = window.innerWidth > 768 ? 3.2 : 2.3;
