                ...
                <div class="edit-panel-btn-row">
                    <a href="https://forms.gle/GUhoeGEupuCa6GQy5" target="_blank" rel="noopener" class="edit-panel-btn">
                        <span class="edit-panel-btn-icon-label">
                            <svg width="20" height="20" fill="none" stroke="#fff" stroke-width="2" viewBox="0 0 24 24"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 1 1 3 3L7 19.5 3 21l1.5-4L16.5 3.5z"/></svg>
                            填写留言
                        </span>
                    </a>
                    <a href="mailto:beimeihaimi@gmail.com" target="_blank" rel="noopener" class="edit-panel-btn">
                        <span class="edit-panel-btn-icon-label">
                            <svg width="20" height="20" fill="none" stroke="#fff" stroke-width="2" viewBox="0 0 24 24"><rect x="2" y="5" width="20" height="14" rx="2"/><path d="m22 5-10 7L2 5"/></svg>
                            联系我们
                        </span>
                    </a>
                    <a href="#" id="share-site-btn" class="edit-panel-btn">
                        <span class="edit-panel-btn-icon-label">
                            <svg width="20" height="20" fill="none" stroke="#fff" stroke-width="2" viewBox="0 0 24 24"><path d="M4 12v7a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-7"/><path d="M16 6l-4-4-4 4"/><path d="M12 2v14"/></svg>
                            分享网站
                        </span>
                    </a>
                </div>
...
// Enhance initializeEditPanel to add share button logic
export function initializeEditPanel() {
    ...
    function openEditPanel() {
        ...
        // Add share button logic after panel is rendered
        const shareBtn = document.getElementById('share-site-btn');
        if (shareBtn) {
            shareBtn.onclick = function(e) {
                e.preventDefault();
                navigator.clipboard.writeText('https://shenmi.world').then(() => {
